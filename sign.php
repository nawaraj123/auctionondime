  ...
  <div class="col-md-6">
    ...
    <section>
      <div id="container_demo" >
        <div id="wrapper">
          <div id="login">
            <form autocomplete="on" action='<?php echo $fgmembersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
...
<div><span class='error'><?php echo $fgmembersite->GetErrorMessage(); ?></span></div>
              ...
              <p class="change_link"> <a href="reset-pwd-req.php">Forget your pasword ?</a> <a href="#toregister" class="to_register">Join us</a> </p>
            </form>
          </div>
        </div>
      </div>
  ...
  <div class="col-md-6">
    ...
    <section>
      <div id="container_demo" >
        <div id="wrapper">
          <div id="login" >
            <form method="post" action="signup_ac.php">
              <p>
              ...
              <p>
                <label for="passwordsignup_confirm" class="youpasswd" >UserName </label>
                <input id="passwordsignup_confirm" name="country" required type="password" placeholder="eg. X8df!90EO"/>
              </p>
              <p>
