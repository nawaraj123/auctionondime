<?php
	...
	if(isset($_POST['submit'])){
		...
		$product->setBid($_POST['bid']);
		//$product->setOprice($_POST['oprice']);
...
<body>
				  ...
				  <table width="100%" border="0" cellspacing="1" cellpadding="0">
					  ...
					  ?>
					   ...
					   <tr bgcolor="#C0C0C0">
						...
						if(file_exists($product->getImage())&&($product->getImage()!='')){ 
						...
						?>
					     ...
					     <td align="center"> <img src="image/no_profile.jpg" width="100" height="80"/></td>
                        <?php } ?>-->
						...
						<td align="center"><img src="../uploadedimages/original/<?php echo $product->getImage() ?>" height="80" /></td>
                        <?php } ?>
   ...
   <td style="" align="center">
      ...
      <?php echo $pagesettingObj->getFirst().'&nbsp;&nbsp;'.$pagesettingObj->getPrev().'&nbsp;&nbsp;'.$pagesettingObj->getNext().'&nbsp;&nbsp;'.$pagesettingObj->getLast(); ?>
         ...
         <option  <?php if(isset($newprodObj)){ echo $newsub->getId()==$newprodObj->getSubcatId()->getId()?"selected":"";}?> value="<?php echo $newsub->getId()?>">
		          <?php echo $newsub->getSubName() ?>
                     ...
                     <!-- <td width="16%" align="center"><strong class="p8">Latest product</strong><input type="checkbox" name="lproduct" <?php if(isset($newprodObj)) echo $newprodObj->getLproduct()?"checked":"" ?>/></td>-->
                      ...
                      <tr bgcolor="#ABABAB">
						<td align="right" colspan="4" width="40%"><strong class="p8">Bid Number</strong></td>
						
						<td width="5%"><input type="text" id="bid" name="bid" value="<?php if(isset($newprodObj)) echo  $newprodObj->getBid() ?>" size="34" style="margin:0 0 0 5px" /></td>
					    ...
					    <!--<tr bgcolor="#ABABAB">
						<td align="right" colspan="4"><strong class="p8">Offer price</strong></td>
						
						<td width="5%"><input type="text" id="oprice" name="oprice" value="<?php if(isset($newprodObj)) echo  $newprodObj->getOprice() ?>" size="34" style="margin:0 0 0 5px" /></td>
					  </tr>-->
        ...
        <td><?php $thumb=explode('/',$newImage->getImages($_GET['id'])); $thumbing="gallery/".$thumb[0];?><img src="<?php echo $thumbing; ?>" height="80"/></td>
                      <?php } ?>
