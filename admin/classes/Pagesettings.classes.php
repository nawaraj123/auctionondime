...
class Pagesettings
   {
	...
	private $linkcondition;
		function setlinkcondition($values)
	            {
				$this->linkcondition=$values;	
				}
	function getlinkcondition()
	            {
	 ...
	 function getPageno($pagenum,$table)
			 ...
			 for($page= 1; $page <=$this->getMaxpage(); $page++)
                 {
						...
						{
                       //$nav .= " $page ";
					   $this->setNav($this->getNav()."<a href=\"".$this->getSelf()."?page=$page{$this->getlinkcondition()}\"><li class=\"active\">$page</li></a>");// no need to create a link to current page
                     ...
                     //    $nav .= " <a href=\"$self?"&page=$page\">$page</a> ";
						 $this->setNav($this->getNav()." <a href=\"".$this->getSelf()."?page=$page{$this->getlinkcondition()}\"><li>$page</li> </a>");
						} 
             ...
             if ($this->getPagenum() > 1)
                  {
                   ...
                   // $prev  = "<a href=\"$self?"&page=$page\">[Prev]</a> ";
					$this->setPrev("<a href=\"".$this->getSelf()."?page=$page{$this->getlinkcondition()}\"><li>Previous</li></a>");
                   // $first = " <a href=\"$self?"&page=1\">[First Page]</a> "; 
					$this->setFirst("<a href=\"".$this->getSelf()."?page=1{$this->getlinkcondition()}\"></a> ");
                } 
            else
               {
         ...
         if ($this->getPagenum()< $this->getMaxpage())
             ...
             //   $next = "<a href=\"".$this->getSelf()."?"&page=$page\">[Next]</a> ";
				$this->setNext("<a   href=\"".$this->getSelf()."?page=$page{$this->getlinkcondition()}\"><li>Next</li></a>");
               // $last = " <a href=\"".$this->getSelf()."?"&page=$maxPage\">[Last Page]</a> ";
				$this->setLast("<a href=\"".$this->getSelf()."&page=".$this->getMaxpage()."\"><li>Last</li></a>");
              } 
        else
          {
