...
<body>
	...
	<div class="content"><!--content open-->
				...
				<br/>
				  ...
				  <table width="100%" border="0" cellspacing="1" cellpadding="0">
					  ...
					  <tr bgcolor="#C0C0C0">
						...
						<td align="center"><img src="../uploadedimages/original/<?php echo $front->getImage() ?>" height="80" /></td>
                        <?php } ?>
            ...
            <td><a href="manage_front.php?delimage=<?php echo $frontObj->getId()?>" onclick="return ConfirmDelete();"><img src="<?php echo $thumbing; ?>" height="80" title="Click image to Remove"/></a>
