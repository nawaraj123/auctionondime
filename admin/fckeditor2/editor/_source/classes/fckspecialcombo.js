...
FCKSpecialCombo.prototype.Create = function( targetElement )
{
	...
	else
	{
		...
		oField.innerHTML = '<table title="' + this.Tooltip + '" class="' + sClass + '" cellspacing="0" cellpadding="0" border="0">' +
				'<tr>' +
					//'<td class="TB_Icon"><img src="../../../../../Dristi_ad_test/fckeditor2/editor/_source/classes/' + FCKConfig.SkinPath + 'toolbar/' + this.Command.Name.toLowerCase() + '.gif" width="21" height="21"></td>' +
					'<td><img class="TB_Button_Padding" src="../../../../../Dristi_ad_test/fckeditor2/editor/_source/classes/' + FCK_SPACER_PATH + '" /></td>' +
					'<td class="TB_Text">' + this.Caption + '</td>' +
					'<td><img class="TB_Button_Padding" src="../../../../../Dristi_ad_test/fckeditor2/editor/_source/classes/' + FCK_SPACER_PATH + '" /></td>' +
					'<td class="TB_ButtonArrow"><img src="../../../../../Dristi_ad_test/fckeditor2/editor/_source/classes/' + FCKConfig.SkinPath + 'images/toolbar.buttonarrow.gif" width="5" height="3"></td>' +
					'<td><img class="TB_Button_Padding" src="../../../../../Dristi_ad_test/fckeditor2/editor/_source/classes/' + FCK_SPACER_PATH + '" /></td>' +
				'</tr>' +
			'</table>' ;
	}
