...
FCK.DataProcessor =
{
	...
	ConvertToHtml : function( data )
	{
        ...
        // [url]
        data = data.replace( /\[url\](.+?)\[\/url]/gi, '<a href="../../../../../Dristi_ad_test/fckeditor2/editor/plugins/bbcode/$1">$1</a>' ) ;
        data = data.replace( /\[url\=([^\]]+)](.+?)\[\/url]/gi, '<a href="../../../../../Dristi_ad_test/fckeditor2/editor/plugins/bbcode/$1">$2</a>' ) ;
