<?php
    ...
    require('../Dbconnection/db_conn.php');
	...
	if(isset($_POST['submit'])){
	    $adds->setHeading($_POST['heading']);
		$adds->setLink($_POST['link']);
		$adds->setPosition($_POST['position']);
		$adds->setDescription($_POST['description']);
			...
			<br/>
				...
				<br/>
				  ...
				  <table width="100%" border="0" cellspacing="1" cellpadding="0">
						...
						<td width="42%" align="center"><strong class="p7">IMAGE</strong></td>
					  ...
					  <tr bgcolor="#C0C0C0">
						...
						<td align="center"><?php echo $add->getHeading()?></td>
                       ...
                       <?php  if($add->getImage()==""){ ?>
						...
						<td align="center"><img src="../uploadedimages/original/<?php echo $add->getImage() ?>" height="80" /></td>
                        <?php } ?>
				...
				<form action="" method="post"  name="frm" enctype="multipart/form-data" >
                    ...
                    <tr bgcolor="#ABABAB">
						...
						<td colspan="4"><input type="text" id="heading" name="heading" value="<?php if(isset($newaddsObj)) echo  $newaddsObj->getHeading() ?>" size="34" style="margin:0 0 0 5px" /></td>
					  </tr>
					<tr bgcolor="#ABABAB">
						<td align="right" colspan="2"><strong class="p8">Image</strong></td>
                        <?php 
                  ...
                  <td><a href="manage_alliance.php?delimage=<?php echo $newaddsObj->getId()?>" onclick="return ConfirmDelete();"><img src="<?php echo $newaddsObj->getImage()?>" height="80" title="Click image to Remove" /></a></td>      
                      ...
                      <tr bgcolor="#ABABAB">
						...
						<td width="76%" colspan="2"><input type="text" id="link" name="link" value="<?php if(isset($newaddsObj)) echo  $newaddsObj->getLink() ?>" size="34" style="margin:0 0 0 5px" /></td>
					  </tr>
					  ...
					  <tr bgcolor="#ABABAB">
					  	<td align="center" colspan="8" >
							<?php 
										...
										if(isset($newaddsObj))
										$oFCKeditor->Value	=  $newaddsObj->getDescription();
