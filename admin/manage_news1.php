...
<body>
	...
	<div class="content"><!--content open-->
			...
			<td align="center"><?php $thumb=explode('/',$news->getImage()); $thumbing="gallery/".$thumb[1];?><img src="<?php echo $thumbing; ?>" height="80" /></td>
                        
                        <?php }?>
                        
						<td width="8%" align="center"><a href="manage_news.php?id=<?php echo $news->getId()?>"><img src="image/edite.png" alt="edit" title="Edit"/></a></td>
				...
				<fieldset>
				<legend><a href="manage_news.php"><input type="button" name="" value="Add New News"/></a></legend>
				<br/>
					...
					<tr bgcolor="#ABABAB">
					  ...
					  <tr bgcolor="#ABABAB">
						...
						$newImage=new News();
                         ...
                         <td><?php $thumb=explode('/',$newImage->getImages($_GET['id'])); $thumbing="gallery/".$thumb[1];?><a href="manage_news.php?delimage=<?php echo $newnewsObj->getId()?>" onclick="return ConfirmDelete();"><img src="<?php echo $thumbing; ?>" height="80" title="Click image to Remove" /></a></td>
                      <?php } ?>
